...
/** Stroke-style icon (1.5px line, round joins) — most icons here. */
...
/** Filled-style icon (no stroke) — used for solid play / moon glyphs. */
const filledBase: IconProps = {
  viewBox: "0 0 16 16",
  fill: "currentColor",
  "aria-hidden": true
};
...
export function DownloadIcon(props: IconProps) {
  return (
    <svg {...strokeBase} strokeWidth={1.6} {...props}>
